        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Center(
                child:data_food==null||data_food.length==0?CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(Colors.redAccent),) :ListView.builder(
