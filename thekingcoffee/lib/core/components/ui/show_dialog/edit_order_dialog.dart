...
class Edit_Order_Dialog extends StatefulWidget {
  ...
  Edit_Order_Dialog(
      ...
      this.toppings,
      this.promotion);
  _Edit_Order_DialogState createState() => _Edit_Order_DialogState();
}

class _Edit_Order_DialogState extends State<Edit_Order_Dialog> {
  var selectedsize;
  ...
  int money;
  TextEditingController note_edit = new TextEditingController();
  @override
  void initState() {
    note_edit.text = widget.note.toString();
    super.initState();
  }
      ...
      widgets_promotion.add(Container(
        child: RadioListTile(
          ...
          onChanged: (value) {
            ...
            // newMoney = ((widget.final_price -
            //         (widget.final_price * (value['PercentDiscount']) / 100) -
            //         value['MoneyDiscount']))
            //     .toInt();
            setState(() {
  ...
  //bien tạm de gen giao dienj, chu sua lại sau nha
  bool checked = false;
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(widget.origin_price.toString(),
                                ...
                                child: Container(
                                  ...
                                  child: CheckboxListTile(
                                    ...
                                    onChanged: (bool value) {
                                      setState(() {
                                        checked_hot = value;
                                        selectedProduct['IsHot'] = checked_hot;
                                      });
                                    },
