                                                                  ...
                                                                  children: <
                                                                              ...
                                                                              children: <Widget>[
                                                                                Row(
                                                                                  ...
                                                                                  children: <Widget>[
                                                                                    StarRating(
                                                                                      size: 13.0,
                                                                                      rating: double.tryParse(search_result[index]['Start'].toString()),
                                                                                      color: Colors.orange,
                                                                                      borderColor: Colors.grey,
                                                                                      starCount: 5,
                                                                                    ),
                                                                                    Text(search_result[index]['Start'].toString(), style: StylesText.style13BrownNormal)
                                                                                  ],
                                                                                ),
                                                                                search_result[index]['IsHot'] == 1
                                                                                    ? Container(
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child:
                                                                            Container(
                                                                          child:
                                                                              CustomPaint(painter: Drawhorizontalline(false, 0.0, 300.0, Colors.blueGrey, 0.5)),
                                                                        )),
                                                                    Padding(
                                                                      padding:
                                                                          const EdgeInsets.fromLTRB(
                                                                              ...
                                                                              children: <Widget>[
                                                                                Row(
                                                                                  ...
                                                                                  children: <Widget>[
                                                                                    ...
                                                                                    Text(
                                                                                      search_result[index]['Price'].toString(),
                                                                                      style: StylesText.style13BrownBold,
                                                                                    )
                                                                                  ],
                                                                                ),
                                                                                Container(
                                                                                  width: Dimension.getWidth(0.63),
                                                                                  child: promotion_list_product == null || promotion_list_product.length == 0
                                                                                      ? IgnorePointer(
                                                                                          ignoring: true,
                                                                                          child: Opacity(
                                                                                              opacity: 0.0,
